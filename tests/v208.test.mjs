...
test("Both export filenames include the current patch version and a sortable timestamp",()=>{
  for(const extension of ["json","xlsx"])assert.equal(exportName(extension,new Date("2026-08-31T12:34:56.123Z")),`Kairo-Ride-2.0.9.2-2026-08-31T12-34-56-123Z.${extension}`);
});
